...
const JoinDeniedBox = ({ noOwnerDialog }) => {
  return (
    <div>
      {noOwnerDialog === true && (
        <Dialog
          open={true}
          onOpenChange={(open) => !open && noOwnerDialog(false)}
        >
            ...
            <DialogHeader className="flex flex-row items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400 mt-1">
                  The user’s request to join this session has been denied. You
                  can retry or return to the main room.
                </p>
              </div>
            </DialogHeader>
